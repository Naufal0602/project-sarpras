...
const LandingPage = () => {
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black text-gray-300 min-h-screen">
      <div className="container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[1, 2, 3].map((num) => (
            ...
            >
              <p className={`flex items-center justify-center text-4xl font-semibold text-${["green", "indigo", "teal"][num - 1]}-400 bg-${["green", "indigo", "teal"][num - 1]}-800 rounded-full shadow-lg w-14 h-14`}>
                {num}
              </p>
              <div className="h-6"></div>
              <p className="font-serif text-3xl">
                {["We build products with UX in mind", "You can trust us to deliver super fast", "We made it simple and easy to do"][num - 1]}
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <ul className="space-y-1 text-gray-400">
            ...
            <li><a href="https://twitter.com/victormustar" className="hover:underline">Twitter</a></li>
            <li><a href="#" className="hover:underline">Linkedin</a></li>
            <li><a href="#" className="hover:underline">Facebook</a></li>
          </ul>
          <ul className="space-y-1 text-gray-400">
            <li className="pb-4 font-serif text-gray-400">Locations</li>
            <li><a href="#" className="hover:underline">Paris</a></li>
            <li><a href="#" className="hover:underline">New York</a></li>
            <li><a href="#" className="hover:underline">London</a></li>
            <li><a href="#" className="hover:underline">Singapour</a></li>
          </ul>
          <ul className="space-y-1 text-gray-400">
          ...
          <ul className="space-y-1 text-gray-400">
            ...
            <li>
              <a href="https://github.com/gary149/landing-gradients" className="self-start px-3 py-2 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
                Get this template
              </a>
            </li>
          </ul>
